    ...
    <nav style={{
      ...
      <div style={{ maxWidth: 960, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", height: 60 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          <Link to="/" style={{ color: "#A8D5B5", textDecoration: "none", fontSize: 14, fontWeight: 500 }}>Feed</Link>
          <Link to="/profile" style={{ color: "#A8D5B5", textDecoration: "none", fontSize: 14, fontWeight: 500 }}>Profile</Link>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <Link to="/profile" style={{
              width: 34, height: 34, borderRadius: "50%", background: "#FFDB00",
              display: "flex", alignItems: "center", justifyContent: "center",
              fontSize: 13, fontWeight: 700, color: "#004D1C", textDecoration: "none"
            }}>{initials}</Link>
            <button onClick={handleSignOut} style={{
              color: "#A8D5B5", fontSize: 13, cursor: "pointer",
